...
maven://com.google.http-client/google-http-client-jackson2/1.21.0|lib/gcloud/google-http-client-jackson2-1.21.0.jar
...
maven://com.google.protobuf/protobuf-java/3.2.0|lib/gcloud/protobuf-java-3.2.0.jar
