...
prompt  APPLICATION 121 - Jasper Reports Integration Test (v2.5.0.0)
--
-- Application Export:
--   Application:     121
--   Name:            Jasper Reports Integration Test (v2.5.0.0)
--   Date and Time:   17:33 Saturday September 29, 2018
...
wwv_flow_api.create_flow(
  ...
  p_name  => nvl(wwv_flow_application_install.get_application_name,'Jasper Reports Integration Test (v2.5.0.0)'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F121101'),
  p_page_view_logging => 'YES',
  p_checksum_salt_last_reset => '20180929173346',
  ...
  p_last_upd_yyyymmddhh24miss=> '20180929173346',
  p_ui_type_name => null,
...
'          p_print_job_name      => :p5_print_job_name'||unistr('\000a')||
'          );'||unistr('\000a')||
'  '||unistr('\000a')||
...
p:=p||'s used before apex 4.1'||unistr('\000a')||
'  --apex_application.g_unrecoverable_error := true;'||unistr('\000a')||
'  apex_application.stop_apex_engine;'||unistr('\000a')||
'EXCEPTION'||unistr('\000a')||
