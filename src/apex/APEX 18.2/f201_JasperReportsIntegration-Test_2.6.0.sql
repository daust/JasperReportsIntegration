...
prompt APPLICATION 201 - Jasper Reports Integration Test (v2.6.0)
--
-- Application Export:
--   Application:     201
--   Name:            Jasper Reports Integration Test (v2.6.0)
...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Jasper Reports Integration Test (v2.6.0)')
